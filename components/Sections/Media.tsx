      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6">
        ...
        <div className="max-w-3xl mb-12 sm:mb-16">
          ...
          <p className="text-zinc-400 text-sm sm:text-base md:text-lg">
            Dokumentationen, Interviews und Berichte über meine Arbeit und das Leben mit Sirga.
          </p>
        </div>
          ...
          {appearances.map((item, index) => {
            ...
            return (
              <a 
                ...
                className="group bg-zinc-800/50 p-5 sm:p-6 hover:bg-zinc-800 transition-colors"
              >
                ...
                <p className="text-sand-500 text-xs uppercase tracking-wider mb-1 sm:mb-2">
                  {item.type}
                </p>
                <h3 className="text-white font-medium mb-1 sm:mb-2 text-sm sm:text-base group-hover:text-sand-400 transition-colors">
                  {item.title}
                </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 p-6 sm:p-8 bg-zinc-800/30 border border-zinc-700/50">
          <div>
            ...
            <p className="text-zinc-400 text-sm sm:text-base mb-4 sm:mb-6">
              Für Journalisten und Medienvertreter stelle ich gerne hochauflösende 
              Fotos, Hintergrundinformationen und Interview-Möglichkeiten zur Verfügung.
            </p>
            <div className="space-y-2 sm:space-y-3">
              {pressAssets.map((asset, index) => {
                ...
                return (
                  <button 
                    key={index}
                    className="w-full flex items-center gap-3 text-left text-zinc-300 hover:text-white text-sm sm:text-base py-2 transition-colors"
                  >
                    <AssetIcon size={16} className="text-sand-500 shrink-0 sm:w-[18px] sm:h-[18px]" />
                    <span>{asset.label}</span>
                    <ExternalLink size={12} className="ml-auto text-zinc-600 shrink-0 sm:w-[14px] sm:h-[14px]" />
                  </button>
                );
              })}
            </div>
          ...
          <div className="lg:border-l lg:border-zinc-700/50 lg:pl-8">
            <h3 className="text-xl sm:text-2xl font-light text-white mb-3 sm:mb-4">Pressekontakt</h3>
            <p className="text-zinc-400 text-sm sm:text-base mb-4 sm:mb-6">
              Anfragen für Interviews, Drehgenehmigungen oder Kooperationen 
              bitte per E-Mail an:
            </p>
            <a 
              href="mailto:press@modisawildlife.org"
              className="inline-flex items-center gap-2 text-sand-400 hover:text-sand-300 transition-colors text-sm sm:text-base"
            >
              <Mail size={16} className="shrink-0 sm:w-[18px] sm:h-[18px]" />
            ...
            <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-zinc-700/50">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm">
                <div>
                  ...
                  <p className="text-white">Valentin Grüner</p>
                </div>
                <div>
                  <p className="text-zinc-500">Herkunft</p>
                  <p className="text-white">Deutschland</p>
                </div>
                <div>
                  <p className="text-zinc-500">Wohnort</p>
                  <p className="text-white">Kalahari, Botswana</p>
                </div>
                <div>
                  <p className="text-zinc-500">Projekt</p>
                  <p className="text-white">Modisa Wildlife</p>
                </div>
              </div>
            </div>
          </div>
